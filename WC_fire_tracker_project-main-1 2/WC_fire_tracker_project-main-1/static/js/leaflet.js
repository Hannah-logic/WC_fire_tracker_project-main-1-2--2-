...
!(function (t, e) {
  ...
  (e.extend = function (t) {
    ...
    return (
      ...
      delete o.includes,
      o.options &&
        ((o.options = n.options ? N(n.options) : {}), l(o.options, t.options)),
      (o._initHooks = []),
  ...
  function $t(t, e, i) {
    return (
      "touchstart" !== e ||
        ...
        (Xt = !0)),
      Yt[e]
        ? ((i = Yt[e].bind(this, i)), t.addEventListener(Kt[e], i, !1), i)
  ...
  function ye(t, e) {
    return void 0 !== t.classList
      ...
      : 0 < (t = we(t)).length && new RegExp("(^|\\s)" + e + "(\\s|$)").test(t);
  }
  function M(t, e) {
    var i;
  ...
  function Ce() {
    le &&
      ((le.style.outline = ue), (ue = le = void 0), E(window, "keydown", Ce));
  }
  function Ze(t) {
    for (
      ;
  ...
  function S(t, e, i, n) {
    ...
    else for (var s = 0, r = (e = U(e)).length; s < r; s++) Be(t, e[s], i, n);
    return this;
  }
    ...
    O = it.extend({
      ...
      initialize: function (t, e) {
        (e = c(this, e)),
          ...
          this.callInitHooks(),
          (this._zoomAnimated =
            de && b.any3d && !b.mobileOpera && this.options.zoomAnimation),
          this._zoomAnimated &&
      ...
      _handleDOMEvent: function (t) {
        ...
        !this._loaded ||
          ...
          ("mousedown" === (e = t.type) && ze(i), this._fireDOMEvent(t, e));
      },
      _mouseEvents: [
        "click",
        "dblclick",
          ...
          ye(this._element, "leaflet-zoom-anim") ||
            (t.touches && 1 !== t.touches.length
              ...
              : ti._dragging ||
                ...
                ((ti._dragging = this)._preventOutline && ze(this._element),
                Te(),
                ae(),
                this._moving ||
                  (this.fire("down"),
          ...
          : ((i = "GeometryCollection" === t),
            ...
            this.eachLayer(function (t) {
              t.toGeoJSON &&
                ...
                i
                  ? n.push(t.geometry)
                  : "FeatureCollection" === (t = Di(t)).type
                  ? n.push.apply(n, t.features)
                  : n.push(t));
            }),
            i
              ? Ni(this, { geometries: n, type: "GeometryCollection" })
        ...
        onAdd: function (t) {
          I.prototype.onAdd.call(this, t),
            ...
            this._source &&
              ...
              this._source instanceof bi || this._source.on("preclick", Ie));
        },
        onRemove: function (t) {
          I.prototype.onRemove.call(this, t),
            ...
            this._source &&
              ...
              this._source instanceof bi || this._source.off("preclick", Ie));
        },
        getEvents: function () {
    ...
    Ji =
      ...
      y.include({
        bindPopup: function (t, e) {
          return (
            (this._popup = this._initOverlay(Yi, this._popup, t, e)),
      ...
      y.include({
        bindTooltip: function (t, e) {
          return (
            ...
            (this._tooltip = this._initOverlay(Ji, this._tooltip, t, e)),
  ...
  var Qi = y.extend({
    ...
    bringToFront: function () {
      return (
        this._map && (ge(this._container), this._setAutoZIndex(Math.max)), this
      );
    },
    bringToBack: function () {
      return (
        this._map && (ve(this._container), this._setAutoZIndex(Math.min)), this
      );
    },
    getContainer: function () {
      return this._container;
  ...
  var en = Qi.extend({
    ...
    _removeTile: function (t) {
      ...
      if (e)
        return (
          e.el.setAttribute("src", Y), Qi.prototype._removeTile.call(this, t)
        );
    },
    _tileReady: function (t, e, i) {
